...
export class CrudService {
  ...
  private userTypeSubject = new BehaviorSubject<any>('');

  public userTypeSubject$ = this.userTypeSubject.asObservable();
  ...
  setUserType(){
    this.userTypeSubject.next(localStorage.getItem('userType'));
  }
